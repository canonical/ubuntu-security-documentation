...
The default configuration of Ubuntu balances usability and security.
However, you can further harden systems carrying dedicated workloads
to reduce their attack surface. Canonical provides the Ubuntu Security
Guide to automatically harden systems to DISA STIG and CIS benchmarks
profiles and generate audit reports. It's available with Ubuntu Pro 
on-premise or ready-built on public clouds. 
